...
export const checkUserSesiion = () => createAction(USER_ACTION_TYPE.CHECK_USER_SESSION)
...
export const signUpSuccess = (user, options) => createAction(USER_ACTION_TYPE.SIGN_UP_SUCCESS, { user, options })
