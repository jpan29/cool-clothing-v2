import { options, UserData } from '../../utils/firebase/firebase.utils'
import {
  Action,
  ActionWithPayload,
  createAction,
...
export type SetCurrentUser = ActionWithPayload<
  ...
  UserData
>
export type CheckUserSesiion = Action<USER_ACTION_TYPE.CHECK_USER_SESSION>
...
export const checkUserSesiion = withMatcher(
  (): CheckUserSesiion => createAction(USER_ACTION_TYPE.CHECK_USER_SESSION)
)
...
export const signUpSuccess = withMatcher(
  (user: User, options: options): SignUpSuccess =>
    createAction(USER_ACTION_TYPE.SIGN_UP_SUCCESS, { user, options })
)
